...
import 'package:cinema_aldo_test/view/feedTopRated.dart';
...
class FeedViewUpcoming extends StatefulWidget {
  const FeedViewUpcoming({super.key});

  @override
  State<FeedViewUpcoming> createState() => _FeedViewUpcomingState();
}

class _FeedViewUpcomingState extends State<FeedViewUpcoming> {
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.of(context).pushAndRemoveUntil(
                      MaterialPageRoute(
                          builder: (context) => const FeedViewTopRated()),
                      (Route<dynamic> route) => false);
                },
              ),
              ListTile(
